...
import { GraphTypeCore, HorizontalBarChartProps } from '@/services/models/panel/types';
import { addViewIdToLayout } from '@/utils';

import { EHorizontalBarChartData } from '../contexts/PanelNewViewStudioHorizontalBarChartProvider';
import { usePanelNewViewStudioHorizontalBarChartContext } from '../hooks/usePanelNewViewStudioHorizontalBarChartContext';
...
export const EditBar: React.FC = () => {
  ...
  const { setEchartData, echartData } = usePanelNewViewStudioHorizontalBarChartContext();
