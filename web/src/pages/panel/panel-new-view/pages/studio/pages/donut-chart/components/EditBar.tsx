...
import { GraphTypeCore, DonutChartProps } from '@/services/models/panel/types';
import { addViewIdToLayout } from '@/utils';

import { EDonutChartData } from '../contexts/PanelNewViewStudioDonutChartProvider';
...
export const EditBar: React.FC = () => {
  ...
  const { setEchartData, echartData } = usePanelNewViewStudioDonutChartContext();
