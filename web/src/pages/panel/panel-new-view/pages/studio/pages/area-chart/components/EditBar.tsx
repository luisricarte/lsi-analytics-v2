...
import { AreaChartProps, GraphTypeCore } from '@/services/models/panel/types';
import { addViewIdToLayout } from '@/utils';

import { EAreaChartData } from '../contexts/PanelNewViewStudioAreaChartProvider';
...
export const EditBar: React.FC = () => {
  ...
  const { setEchartData, echartData } = usePanelNewViewStudioAreaChartContext();
